      ...
      <div class="modal-content well">
        ...
        <form action="/db/add_page.php" enctype="multipart/form-data" method="POST" role="form">
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group float-label-control">
            ...
            <input type="text" class="form-control" name="txtCode" id="txtCode" required="required" placeholder="Code">
          </div>
          <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group float-label-control">
            <label for="txtTitle">Title</label>
            <input type="text" class="form-control" name="txtTitle" id="txtTitle" required="required" placeholder="Title">
          </div>

          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group float-label-control">
            <label for="txtContent">Content</label>
            <textarea name="txtContent" id="txtContent" required="required"> </textarea>
          </div>
          <div class="modal-footer">
            <div style="float: right;">
              <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
              <button type="submit" id="addPage" name="addPage" class="btn btn-primary">Submit</button>
            </div>
          </div>
        </form>
      </div>
