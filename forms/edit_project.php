 ...
 ?>
  ...
  <body>
    ...
    <div class="container">
      ...
      <?php 
      if($role == 0){
      $querySelectAllProject = "SELECT * FROM projects";
      $rs = mysql_query($querySelectAllProject) or die("Query to get insert new page failed " . mysql_error());
      if(mysql_num_rows($rs)> 0){
        echo'
        <div class="modal-content well">
          <form method="POST" role="form">
            <legend>Select a project to edit</legend>
            ...
            <ul>
              ...
              while ($row = mysql_fetch_array($rs)) {
                ...
                <li>
                <label>
                  <input type="radio" name="txtGroupName" id="input" value="'.$pName.'"> '
                  .$pName.
                '</label>
        ...
        echo '
          <div class="alert alert-warning">
              ...
              <center>
                <strong>Warning!</strong> There is no project.
            </center>
          </div>
        ';
