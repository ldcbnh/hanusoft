<?php 
$title = "Selsect a project to delete";
  ...
  <body>
    ...
    <div class="container">
      ...
      if(mysql_num_rows($rs)> 0){
        ...
        <center>
          <form action="delete_project_message.php" method="POST" role="form">
            <legend>Select a project to delete</legend>
            <div class="form-group">
              <table>
                <tr>
                   <th class="well">Name</th>
                   <th class="well">Description</th>
                </tr>
              <tbody>';
                  while ($row_group = mysql_fetch_array($rs)) {
                    $pName = $row_group['name'];
                    $pID = $row_group['id'];
                    $pDes = $row_group['description'];
                    echo '
                    <tr>
                        <td class="well"><h4><input type="radio" name="pID" id="input" required="required" value="'.$pID.'"> '
                          .$pName.'</h4>
                        </td>
                        <td class="well"><h4> '.$pDes.'</h4>
                        </td>
                    </tr>';
            ...
            <button type="submit" name="selectProject" id ="selectProject" class="btn btn-primary">Continue</button>
          </form>
        </center>
          </div>
          ';
          ...
          echo '
            <div class="alert alert-warning">
                ...
                <center>
                  <strong>Warning!</strong> There is no project added!.
              </center>
            </div>
          ';
      }
