...
include '../db/checklogin.php';
 ...
 ?>
  ...
  <body>
    ...
    <?php 
      if ($role ==0) {
        if (isset($_POST['editGroupAs'])) {
          $group_id = $_POST['groupID'];
          if(isset($_POST['inMembers'])){
            $oldMembers = $_POST['inMembers'];
            $query1 = "SELECT * FROM group_assignments WHERE group_id='".$group_id."'";
            ...
            while ($row1 = mysql_fetch_array($rs1)) {
              ...
              if(in_array($old_user_id, $oldMembers)){
                ...
                $query1a = "DELETE FROM group_assignments WHERE user_id ='".$old_user_id."' AND group_id ='".$group_id."'";
          ...
          if(isset($_POST['outMembers'])){
            ...
            for($x = 0; $x < count($newMembers); $x++){
                $query1b = "INSERT INTO group_assignments (group_id, user_id) VALUE ('".$group_id."','".$newMembers[$x]."')";
                echo $query1b;
