<?php 
$title = "Selsect a group to delete";
  ...
  <body>
    ...
    <div class="container">
      ...
      if(mysql_num_rows($rs)> 0){
        ...
        <center>
          <form action="delete_group_message.php" method="POST" role="form">
            <legend>Select a group to Delete</legend>
            <div class="form-group">
              ...
              <tbody>';
                  while ($row_group = mysql_fetch_array($rs)) {
                    ...
                    $gID = $row_group['id'];
                    $gDes = $row_group['description'];
                    echo '
                    <tr>
                        <td class="well"><h4><input type="radio" name="txtGroupName" id="input" required="required" value="'.$gID.'"> '
                          .$gName.'</h4>
                        </td>
                        <td class="well"><h4> '.$gDes.'</h4>
                        </td>
                    </tr>';
            ...
            <button type="submit" name="selectGroup" id ="selectGroup" class="btn btn-primary">Continue</button>
          </form>
        </center>
          </div>
          ';
