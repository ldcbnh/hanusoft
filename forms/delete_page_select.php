<?php 
$title = "Selsect a page to delete";
  ...
  <body>
    ...
    <div class="container">
      ...
      if(mysql_num_rows($rs)> 0){
        ...
        <center>
          <form action="delete_page_massage.php" method="POST" role="form">
            <legend>Select a page to Delete</legend>
            <div class="form-group">
              <table>
              <thead>
                <tr>
                   <th class="well">ID</th>
                   <th class="well">Code</th>
                </tr>
              <tbody>';
            ...
            <button type="submit" name="selectPage" id ="selectPage" class="btn btn-primary">Continue</button>
          </form>
        </center>
          </div>
          ';
