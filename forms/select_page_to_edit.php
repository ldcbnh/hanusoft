  ...
  <body>
    ...
    <div class="container">
      ...
      if(mysql_num_rows($rs)> 0){
        ...
        <center>
          <form action="edit_page.php" method="POST" role="form">
            ...
            <div class="form-group">
              ...
              <tbody>';
                  while ($row = mysql_fetch_array($rs)) {
                    ...
                    echo '
                    <tr>
                        <td class="well"><h4><input type="radio" name="pageID" id="input" required="required" value="'.$pID.'"> '
                          .$pID.'</h4>
                        </td>
                        <td class="well"><h4>'.$pCode.'</h4></td>
                    </tr>';
