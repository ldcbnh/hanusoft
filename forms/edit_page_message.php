    ...
    <?php 
      if ($role ==0) {
        if (isset($_POST['editPage'])) {
          ...
          $page_code = $_POST['txtCode'];
          $page_title = $_POST['txtTitle'];
          $page_content = $_POST['txtContent'];

          $query1 = "UPDATE pages SET code ='".$page_code."', title='".$page_title."', content='".$page_content."' WHERE id ='".$page_id."'" ;
