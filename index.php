...
?>
  ...
  <div class="col-xs-8 col-sm-8 col-md-8 well well-lg ">
...
while ($row = mysql_fetch_array($rs_all_members)) {
	...
	if (is_null($avatar)) {echo 'img/avatars/default.jpg';} else {echo 'img/avatars/' . $avatar . '"';}
	echo '"alt="">
...
while ($row_project = mysql_fetch_array($rs_all_projects)) {
	...
	echo '
				...
				<div class="col-md-12">
					<right>
						<a href="selected_project.php?id=' . $project_id . '" title="">Learn more...</a>
