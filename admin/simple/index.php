...
?>
  ...
  <head>
    ...
    .table_view tr.odd:hover,
    .table_view tr.even:hover {
      background: #FEFDE0;
    }
          ...
          <form action="<?php $_SERVER['PHP_SELF']; ?>" method="get" name="amtForm">
            <table align="center">
              <tr>
                <td>Amount</td>
                <td>
                  <input type="text" name="amt" class="input" <?php if(isset($_GET[ "amt"])) { ?> value="
                  <?php echo $_GET["amt"]; ?>"
                    <?php } ?> /></td>
                <td>
        ...
        ?>
            ...
            ?>
                  <tr>
                    ...
                    <td>
                      <input type="text" name="fname<?php echo $i; ?>" class="input" />
                    </td>
                    <td>
                      <input type="text" name="lname<?php echo $i; ?>" class="input" />
                    </td>
                    <td>
                      <input type="text" name="qualification<?php echo $i; ?>" class="input" />
                    </td>
                  </tr>
                  <?php
                }
            ?>
                    <tr>
                      <td colspan="4" align="center">
                        ...
                        <?php // Post the total rows count value ?>
        ...
        elseif(isset($_GET['update'])) {
            ...
            ?>
                            <tr>
                              ...
                              <td>
                                <input type="text" name="fname<?php echo $i; ?>" value="<?php echo $row['fname']; ?>" class="input" />
                              </td>
                              <td>
                                <input type="text" name="lname<?php echo $i; ?>" value="<?php echo $row['lname']; ?>" class="input" />
                              </td>
                              <td>
                                <input type="text" name="qualification<?php echo $i; ?>" value="<?php echo $row['qualification']; ?>" class="input" />
                              </td>
                            </tr>
                            <?php
                }
