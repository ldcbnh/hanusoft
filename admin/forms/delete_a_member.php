<a class="btn btn-primary" data-toggle="modal" href='#modal-add-group'><span class="fa fa-user-times" aria-hidden="true"></span> Delete a member</a>
<div class="modal fade " id="modal-add-group">
	<div class="modal-dialog">
		<div class="modal-content well">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Select a membet</h4>
			</div>
